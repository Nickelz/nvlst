...
# Database: nvlst
# Generation Time: 2020-04-18 13:47:18 +0000
# ************************************************************
...
CREATE TABLE `Books` (
  ...
  `des` text NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `isbn_issn_unique` (`ISBN`,`Pages`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `Books` WRITE;
/*!40000 ALTER TABLE `Books` DISABLE KEYS */;

INSERT INTO `Books` (`ID`, `Title`, `Author_Name`, `Genre`, `Language`, `Release_Date`, `Price`, `Provider`, `ISBN`, `Pages`, `rating`, `des`)
VALUES
...
INSERT INTO `OrderHistory` (`OrderID`, `UserID`, `Books`, `Date`)
VALUES
	(1,0,'1,2','date(Y/m/d)'),
	(2,0,'1,2','date(Y/m/d)'),
	(3,6,'1,2','date(Y/m/d)'),
...
INSERT INTO `wishlist` (`ID`, `UserID`, `Books`)
VALUES
	(1,3,''),
	(2,4,''),
	(3,5,''),
